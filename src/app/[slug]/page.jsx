...
export default function Page({ params }) {
  ...
  return (
    <>
      ...
      {/* Main Content */}
      <section className="mx-auto max-w-(--breakpoint-xl) py-12 md:py-16 lg:px-8 lg:py-20">
        <div className="w-full lg:flex lg:space-x-8">
          {/* Page Content */}
          <div className="lg:w-2/3">
            {/* Uses the official Tailwind CSS Typography plugin */}
            <div className="prose mx-auto px-5 sm:prose-lg first-letter:text-4xl first-letter:font-bold first-letter:tracking-[.15em] prose-a:transition prose-a:duration-300 prose-a:ease-in-out prose-a:hover:text-primaryred prose-img:rounded-xl sm:px-6 md:px-8 lg:mx-0 lg:px-0">
