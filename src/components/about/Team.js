    ...
    <section className="bg-gray-50 py-12 sm:py-20 lg:py-28">
      <div className="mx-auto max-w-xl px-4 sm:max-w-3xl sm:px-6 md:px-8 lg:max-w-(--breakpoint-xl)">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h3 className="mt-2 text-3xl font-medium tracking-normal text-secondaryblue sm:text-4xl md:tracking-tight lg:text-5xl lg:leading-tight">
        ...
        {/* Team */}
        <div className="mx-auto mt-12 max-w-(--breakpoint-xl) sm:mt-16">
              ...
              >
                <div>
                  ...
                  <div className="mt-6 leading-6">
                    <h3 className="text-xl font-medium text-secondaryblue">
