...
export default function Partners() {
  return (
    <section className="py-12 sm:pb-20 lg:pb-24">
      <div className="mx-auto max-w-xl px-4 sm:max-w-3xl sm:px-6 md:px-8 lg:max-w-(--breakpoint-xl)">
        {/* Section Header */}
        <h3 className="relative border-b border-gray-200 pb-2.5 text-2xl font-medium text-secondaryblue before:absolute before:-bottom-px before:left-0 before:h-px before:w-24 before:bg-red-600 before:content-['']">
          Our Syndication Partners
        </h3>

        {/* Logos */}
        <div className="mx-auto mt-8 max-w-(--breakpoint-xl) lg:mt-12">
