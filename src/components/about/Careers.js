...
export default function Careers() {
  return (
    <section className="bg-white py-12 sm:py-20 lg:py-28">
      <div className="mx-auto grid max-w-xl gap-12 px-5 sm:max-w-3xl sm:px-6 md:px-8 lg:max-w-(--breakpoint-xl) lg:grid-cols-2 lg:gap-16">
        {/* Content */}
        <div>
          <h2 className="max-w-lg text-3xl font-medium tracking-normal text-secondaryblue sm:text-4xl md:tracking-tight lg:text-5xl lg:leading-tight">
          ...
          <div className="mx-auto mt-6 text-lg leading-8 text-gray-500">
            ...
            <Link
              href="#0"
              className="group mt-4 inline-flex items-center text-red-600 no-underline transition duration-300 ease-in-out hover:text-primaryred sm:mt-5"
            >
              Join our team
          ...
          <ul className="space-y-12 lg:space-y-14">
            {locations.map((location) => (
              <li key={location.name} className="flex">
                <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-lg bg-gray-50 text-secondaryblue sm:h-16 sm:w-16">
                  <location.icon className="h-6 w-6 sm:h-7 sm:w-7" />
                </div>

                <div className="ml-3.5 w-full sm:ml-6">
                  <p className="text-lg font-medium leading-6 text-secondaryblue">
                    {location.name}
                  </p>
