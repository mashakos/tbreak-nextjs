...
export default function AuthorHeader({ author }) {
  return (
    <section className="bg-gray-50 py-12 sm:py-16 md:py-20 lg:py-24">
      <div className="mx-auto max-w-xl px-6 sm:px-12 md:max-w-3xl lg:max-w-(--breakpoint-xl) lg:px-8">
        {/* Container */}
        <div className="flex w-full flex-col items-center md:flex-row md:justify-between">
          ...
          <div className="flex flex-col items-center md:flex-row">
            ...
            <div className="mt-6 text-center md:ml-5 md:mt-0 md:text-left">
              ...
              <h1 className="mt-1.5 text-3xl font-medium tracking-normal text-secondaryblue sm:text-4xl md:tracking-tight lg:leading-tight">
                {author.name}
              </h1>
            </div>
          </div>
