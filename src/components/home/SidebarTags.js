...
function Tag({ tag }) {
  ...
  return (
    <li>
      <Link href={tagPath}>
        <span className="m-1 inline-flex items-center rounded-full border border-gray-300/70 bg-transparent px-4 py-1 text-sm font-medium text-gray-800 transition duration-300 ease-in-out hover:text-primaryred sm:px-4 sm:py-1.5">
          {tag}
        </span>
      </Link>
    </li>
