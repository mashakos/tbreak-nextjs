          ...
          >
            ...
            <div className="order-1 mt-5 w-full px-2 sm:mr-4 sm:mt-0 sm:max-w-sm sm:px-0 lg:order-2 lg:ml-4 lg:mr-0 lg:flex-1">
              <Link
                ...
                className="text-xs font-medium uppercase tracking-widest text-primaryred transition-colors duration-300 ease-in-out hover:text-red-600 lg:hidden 2xl:block"
              >
                {article.category.name}
              </Link>

              <Link href={article.url}>
                <h3 className="mt-2 text-lg font-medium tracking-normal text-secondaryblue decoration-gray-800 decoration-2 transition duration-300 ease-in-out hover:underline lg:text-md xl:text-lg xl:leading-normal">
                  {article.title}
                </h3>
              </Link>
