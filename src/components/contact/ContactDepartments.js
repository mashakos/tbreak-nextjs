  ...
  return (
    <div className="mx-auto max-w-xl px-5 sm:px-8 md:max-w-2xl lg:max-w-none lg:px-0 lg:pr-24 xl:pr-48">
      ...
      <div className="relative mt-10">
        ...
        <div className="grid gap-12 sm:grid-cols-2">
          {departments.map((department) => (
            <div key={department.title}>
              <h3 className="text-lg font-medium leading-6 text-secondaryblue ">
                {department.title}
              </h3>
              <div className="mt-2 space-y-1 text-md">
                ...
                <a
                  ...
                  className="text-primaryred transition duration-300 ease-in-out hover:text-red-800"
                >
        ...
        <div className="prose mt-10 text-md text-gray-500 prose-a:text-gray-800 prose-a:transition prose-a:duration-300 prose-a:ease-in-out prose-a:hover:text-primaryred sm:mt-12">
